    ...
    renderConfigScreen() {
      ...
      this.renderContent(`
        <div style="display:flex;flex-direction:column;align-items:center;">
          ...
          <p style="font-family: 'Inter', sans-serif;font-weight: 600;margin:14px 0 6px;font-size:15px;color:#a6adc8;width:100%;text-align:left;transform:translateY(9px);">Modelo de IA:</p>
          ...
          <div style="font-size:11px;color:#6c7086;margin-bottom:4px;width:100%;text-align:left;transform:translateY(9px);">
          ...
          <p style="margin:0 0 8px;font-size:15px;color:#a6adc8;width:100%;text-align:left;font-family: 'Inter', sans-serif;font-weight: 600;transform:translateY(9px);">Intervalo de auto-página (minutos):</p>
